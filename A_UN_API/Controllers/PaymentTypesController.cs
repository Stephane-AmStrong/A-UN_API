...
namespace A_UN_API.Controllers
{
    ...
    public class PaymentTypesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<PaymentTypeReadDto>>> GetAllPaymentTypes([FromQuery] PaymentTypeParameters queryParameters)
        {
            var paymentTypes = await _repository.PaymentType.GetAllPaymentTypesAsync(queryParameters);
