...
namespace A_UN_API.Controllers
{
    ...
    public class RegistrationFormLinesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<RegistrationFormLineReadDto>>> GetAllRegistrationFormLines([FromQuery] RegistrationFormLineParameters queryParameters)
        {
            var registrationFormLines = await _repository.RegistrationFormLine.GetAllRegistrationFormLinesAsync(queryParameters);
