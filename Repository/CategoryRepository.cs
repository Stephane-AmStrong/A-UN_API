...
namespace Repository
{
    public class CategoryRepository : RepositoryBase<Category>, ICategoryRepository
    {
        ...
        public async Task<PagedList<Category>> GetCategoriesAsync(CategoryQueryParameters categoryParameters)
        {
        ...
        private void ApplyFilters(ref IQueryable<Category> categories, CategoryQueryParameters categoryParameters)
        {
            categories = FindAll();
            /*
