...
namespace Repository
{
    public class AccountRepository : RepositoryBase<AppUser>, IAccountRepository
    {
        ...
        public async Task<AuthenticationResponse> UpdateUserAsync(AppUser user)
        {
            if (user == null) throw new ArgumentNullException(nameof(user));
            user.UpdatedAt = DateTime.Now;
        ...
        public async Task<AuthenticationResponse> SignInAsync(LoginRequest loginRequest, string password)
        {
