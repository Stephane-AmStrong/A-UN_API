...
namespace Repository
{
    public class BannerRepository : RepositoryBase<Banner>, IBannerRepository
    {
        ...
        public async Task<PagedList<Banner>> GetBannersAsync(BannerQueryParameters bannerParameters)
        {
        ...
        private void ApplyFilters(ref IQueryable<Banner> banners, BannerQueryParameters bannerParameters)
        {
            banners = FindAll();
            /*
